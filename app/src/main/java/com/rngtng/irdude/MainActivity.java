...
public class MainActivity extends Activity {
	ConsumerIrManager irdaService;
    CarrierFrequencyRange frequencyRange;
    Method irWrite;
	...
	public void irInit() {
        System.out.println(android.content.Context.CONSUMER_IR_SERVICE);
        irdaService = (ConsumerIrManager)this.getSystemService(android.content.Context.CONSUMER_IR_SERVICE);
        CarrierFrequencyRange[] range = irdaService.getCarrierFrequencies();
        if (range.length > 0) {
            frequencyRange = range[0];
        }
        /*
	...
	public void irSend(View view) {
        ...
        irdaService.transmit(frequencyRange.getMinFrequency(), new int[]{1,2,3,4});
	}
